...
public class ProjectController {
    ...
    private ProjectDTO getProject(@PathVariable Integer projectId, @AuthenticationPrincipal(expression = "username") String username){
    ...
    private void renameProject(@PathVariable int projectId, @Validated @RequestBody ProjectDTO project, @AuthenticationPrincipal(expression = "username")String username){
